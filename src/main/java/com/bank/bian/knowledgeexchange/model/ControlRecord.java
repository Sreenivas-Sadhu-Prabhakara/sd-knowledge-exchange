package com.bank.bian.knowledgeexchange.model;
...
/**
 * The BIAN control record for this service domain: "Knowledge Article Operating Session".
 *
 ...
 * to its asset type (Knowledge Article). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Knowledge Article Operating Session";
